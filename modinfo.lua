...
meta =
{
    ...
    title = "AutoTrader: Automated Trading Command",

    -- Description of your mod that will be displayed to players
    description = "Adds a command to enable automated, multi-sector trading for fleet ships",

    -- Insert all authors into this list
    authors = {"Nick Gerner (notgerner)"},
    ...
    -- most of the AI runs server-side
    serverSideOnly = false,

    -- Set to true if the mod only has to run on the client, such as UI mods
    -- player can order a ship to be an auto trader
